			...
			<div class="column is-10">
				...
				<div class="formwrap">
					<form action="${path1 }/notice/edit.do" method="post">
						...
						<div class="field">
							<label class="label" for="content">공지사항 내용</label>
							<textarea name="content" class="textarea" id="content" placeholder="공지사항 내용" rows="8" cols="100" maxlength="800" required>${dto.content }</textarea>
						</div>
