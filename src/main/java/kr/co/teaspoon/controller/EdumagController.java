...
public class EdumagController {
    ...
    @GetMapping("list.do")
    public String getedumagList(Model model) throws Exception {
        List<Edumag> edumagList = edumagService.edumagList();
        //로그인 한 아이디
    ...
    public void imageUpload(HttpServletRequest request,
        ...
        try{
            ...
            //이미지 경로 생성
            String path = "E:\\Teaspoon\\src\\main\\webapp\\resources\\img";	// 이미지 경로 설정(폴더 자동 생성)
            ...
            String fileUrl = "/weekitalk/edumag/ckImgSubmit.do?uid=" + uid + "&fileName=" + fileName; // 작성화면
    ...
    public void ckSubmit(@RequestParam(value="uid") String uid
        ...
        //서버에 저장된 이미지 경로
        String path = "E:\\Teaspoon\\src\\main\\webapp\\resources\\img";	// 저장된 이미지 경로
